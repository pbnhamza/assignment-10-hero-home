...
const Register = () => {
  ...
  return (
    ...
    >
      <div className="card bg-[#488CFB] w-full mx-auto max-w-sm shrink-0 shadow-2xl">
        <div className="card-body">
          ...
          <form onSubmit={handleRegister}>
            <fieldset className="fieldset">
              ...
              <button className="btn text-white  rounded bg-linear-to-r from-pink-500 to-red-600">
                Register
              </button>
            </fieldset>
          </form>
          ...
          <p className="text-center">
            ...
            <Link className="text-blue-900 hover:text-white" to="/Auth/login">
              Login
            </Link>{" "}
          </p>
        </div>
